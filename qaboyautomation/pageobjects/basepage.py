...
class BasePage:
    ...
    @allure.step('Validate title is present')
    ...
    @allure.step('Validate icon is present')
    ...
    @allure.step('Validate menu options are present')
    ...
    @allure.step('Validate social media links are present')
